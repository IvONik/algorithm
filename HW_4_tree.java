...
public class HW_4_tree<T extends Comparable<T>> { 
        // TODO: 29.05.2023
        ...
        // Метод, который удаляет ноду и возвращает ту ноду, которая будет вместо
        // удаленной
        private Node removeNode(Node current, T value) {
            ...
            if (value.compareTo(current.value) < 0) { // value.compareTo(current.value) < 0
